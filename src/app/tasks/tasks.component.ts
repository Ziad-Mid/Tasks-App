...
export class TasksComponent implements OnInit {
  ...
  persistTask(){
    ...
    searchTasks(){
      this.resultTasks = this.tasks.filter((task)=> task.label.toLowerCase().includes(this.searchText.toLowerCase()))  //(task) : function callback / the return type
    }
}
